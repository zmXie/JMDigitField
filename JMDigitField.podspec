#
# Be sure to run `pod lib lint JMDigitField.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'JMDigitField'
  s.version          = '0.1.0'
  s.summary          = 'A short description of JMDigitField.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zmXie/JMDigitField'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zmXie' => 'xiezm@dachentech.com.cn' }
  s.source           = { :git => 'https://github.com/zmXie/JMDigitField.git', :tag => s.version.to_s }
